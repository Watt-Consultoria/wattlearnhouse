...
Campos de nome completo/CPF no perfil do aluno, condição de elegibilidade (curso 100% concluído), emissão idempotente do certificado de conclusão com snapshot do currículo concluído, e a tela autenticada de visualização/impressão do certificado do aluno.
