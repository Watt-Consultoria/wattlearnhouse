...
Página de estatísticas por curso — conclusão por módulo calculada sobre alunos matriculados, e percentual de acerto/erro por questão de quiz considerando a primeira tentativa de cada aluno.
