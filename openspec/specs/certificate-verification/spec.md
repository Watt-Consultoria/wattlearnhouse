...
Rota pública (sem autenticação) de consulta de um código de verificação, exibindo os dados do certificado correspondente ou indicando que o código é inválido.
