...
Editor de conteúdo de aulas usado pelo professor, com preview de Markdown lado a lado em tempo real, barra de ferramentas de formatação (incluindo embed de vídeo do YouTube e equações matemáticas via KaTeX), e adaptação para uso em viewports estreitas.
