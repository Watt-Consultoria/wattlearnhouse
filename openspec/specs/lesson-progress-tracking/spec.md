...
Rastreamento de progresso por usuário: conclusão de aula persistida, cálculo de progresso por módulo/curso a partir de dado real, e regra de desbloqueio sequencial de módulos (módulo N só libera quando o módulo N-1 está 100% concluído, incluindo quiz aprovado se houver).
