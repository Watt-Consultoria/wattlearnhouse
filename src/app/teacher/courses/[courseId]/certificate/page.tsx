...
export default async function TeacherAuthorshipCertificatePage({
  params,
  searchParams,
}: {
  ...
  // Escopado sempre ao usuário da sessão — só existe uma linha aqui se o próprio
  // usuário já emitiu (e é o dono do curso, checado na emissão).
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-4 py-8 sm:px-6 print:max-w-none print:px-12 print:py-10">
        ...
        <div className="rounded-2xl border-2 border-brand-navy/15 bg-card p-8 shadow-sm sm:p-12 print:border-0 print:shadow-none">
          ...
          <p className="text-center text-xs font-medium tracking-[0.2em] text-muted-foreground uppercase">
            Certificado de autoria e instrução de curso
          </p>

          <p className="mt-6 text-center text-sm leading-relaxed text-muted-foreground">
            A <strong>{ISSUER_NAME}</strong>, empresa devidamente inscrita sob o CNPJ{" "}
            {ISSUER_CNPJ}, certifica, para os devidos fins, que
          </p>
          ...
          <p className="mt-6 text-center text-sm leading-relaxed text-muted-foreground">
            foi responsável pela criação, pela ministração e pela redação do conteúdo das
            aulas do curso
          </p>
          ...
          <p className="mt-2 text-center text-sm text-muted-foreground">
            atuando como autor(a) e instrutor(a) do material didático relacionado a
            seguir, conforme registrado na plataforma WattLearnHouse em{" "}
          ...
          <div className="mt-10 flex flex-col items-center gap-1 border-t border-border pt-6 text-center">
            ...
            <p className="mt-3 max-w-md text-[11px] leading-relaxed text-muted-foreground">
              Documento emitido eletronicamente por {ISSUER_NAME}, CNPJ {ISSUER_CNPJ},
              através da plataforma WattLearnHouse.
            </p>
          </div>
        </div>
      </main>
